...
- режимов 00h - 06h ---  B800
- монохромного текстового режима (т.е. 07h) --- B000

/ Вопрос 2: Укажите число страниц, разрешение и число цветов для видеорежима 03.

Число страниц = 4 (страницы 0-3), разрешение = 720х480, число цветов = 16
...
Для пурпурных символов на голубом фоне BL=0, R=0, G=1, B=1, I=0, R=1, G=0, B=1. Для зеленых символов на белом мигающем фоне BL=1, R=1, G=1, B=1, I=0, R=0, G=1, B=0
