...
.data 
Names db 'Zhelezko Alexander 251', 0Dh, 0Ah, '$'
enter db 0Dh, 0Ah, '$'
...
mov AL, 1 ; занесение первой цифры в регистр AL
mov BL, 2 ; занесение второй цифры в регистр BL
